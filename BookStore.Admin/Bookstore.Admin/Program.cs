...
using Bookstore.Admin.Repository.Service;
...
namespace Bookstore.Admin
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                ops.UseSqlServer(builder.Configuration["connectionString:BookStoreAdminDB"]);
            });
            ...
            {
                option.SwaggerDoc("v1", new OpenApiInfo { Title = "Admin", Version = "v1" });
